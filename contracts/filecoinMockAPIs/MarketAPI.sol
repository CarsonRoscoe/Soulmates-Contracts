...
contract MarketAPI {
    ...
    function get_deal_data_commitment(MarketTypes.GetDealDataCommitmentParams memory params)
        public
        view
    ...
    function get_deal_provider(MarketTypes.GetDealProviderParams memory params)
        public
        view
    ...
    function get_deal_epoch_price(MarketTypes.GetDealEpochPriceParams memory params)
        public
        view
    ...
    function get_deal_client_collateral(MarketTypes.GetDealClientCollateralParams memory params)
        public
        view
    ...
    function get_deal_provider_collateral(MarketTypes.GetDealProviderCollateralParams memory params)
        public
        view
    ...
    function get_deal_verified(MarketTypes.GetDealVerifiedParams memory params)
        public
        view
    ...
    function get_deal_activation(MarketTypes.GetDealActivationParams memory params)
        public
        view
